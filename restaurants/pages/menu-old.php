<?php
	...
	<br>
		<nav class="navbar navbar-default topnav hidden-sm hidden-md hidden-lg <?php echo (isset($theme_color)?$theme_color:""); ?>" data-spy="affix" data-offset-top="197" style="100%">
			<div class="container">
				...
				<div class="dropdown-menu dropdown-menu-right" id="navMenu" style="margin: 3%; padding: 2%;">
					<a href="index.php?a=place-order" class="btn btn-block btn-default <?php echo (isset($theme_color)?$theme_color:""); ?>">Complete Order</a>
					
					<h4 class="dropdown-header <?php echo (isset($theme_text)?$theme_text:""); ?>">Orders</h4>
		...
		<main class="container" >
			<div class="">
				...
				<nav class="hidden-xs col-sm-2 <?php echo (isset($theme_text)?$theme_text:""); ?>" id="myScrollspy">
							...
							echo '<section class="row" id="'.$menu['id'].'">
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="'.(isset($theme_text)?$theme_text:"").'">'.$menu['menu'].'</h4>
											</div>
												...
												echo '<div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
															<div class="thumbnail">
																...
																<div class="badges-ribbon">
																	<div class="badges-ribbon-content" style="background-color: '.(isset($theme_hex)?$theme_hex:"").'">Special</div>
																</div>
																').'
																<img src="assets/images/menu-items/'.$item['image'].'" class="thumbnail img-responsive"/>
																<hr style="margin-top: 8px; margin-bottom:-10px;">
																<div class="caption">
																	<h5 class="truncate">'.$item['menu_item'].'</h5>
																	<span>
																		<span class="pull-right">
																			<button type="button" class="btn-menu-select '.(isset($theme_text)?$theme_text:"").'"  data-toggle="modal" data-target="'.(($selected)?'#removeOrder':'#yourOrder').'" data-img="'.$item['image'].'" 
				...
				<div class="hidden-xs col-sm-3">
					<div class="sidebar orders">
						<div class="panel panel-default" >
							<div class="panel-heading <?php echo (isset($theme_color)?$theme_color:""); ?>">
							...
							<div class="panel-footer">
								<?php 
									if(isset($_SESSION['order'])){
										...
										<p class="'.(isset($theme_text)?$theme_text:"").'">'.number_format($order_obj->estimate_time(), 0).' minutes</p>';
									}
						...
						<a href="index.php?a=place-order" class="btn btn-block btn-default <?php echo (isset($theme_color)?$theme_color:""); ?> text-right" >Complete Order <span class="fa fa-chevron-circle-right"></span></a>
					</div>
				</div>
				<!-- End Orders -->
			</div>
		...
		<div class="col-md-3 hidden-sm wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
					<ul class="list-item">	
						<li>
							<a href="index.php?a=actions-list" class="btn btn-primary btn-block">
								<h4>Complete Order <i class="fa fa-arrow-circle-right"></i></h4>
							</a>
						</li>
						<li class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
								<h4 class="btn-block">
									Place an Order<span class="pull-right" style="margin-left:10px;"> x </span><span class="pull-right">N1000  </span>
								</h4>
						</li>
					</ul>
				</div>
