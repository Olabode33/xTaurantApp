<?php
	...
	// }
?>
<section class="section" style="min-height:720px;">
	<br>
		<div class="container">
			...
			<?php
				...
				?>
						...
						<div class="">
							<p>Would you like to place another order the same table?</p>
				...
				<?php
					...
					case 'feedback':
						echo '<h3><i class="fa fa-info-circle"></i> Feedback Submitted</h3>
								  ...
								  <h4>Would you like to provide more feedback?</h4>
									 <a href="index.php?a=feedback&more=2'.((isset($_GET['ag']))?'&ag='.$_GET['ag']:'').((isset($_GET['gd']))?'&gd='.$_GET['gd']:'').'" class="btn btn-success '.(isset($theme_color)?$theme_color:'').'"><span class="fa fa-check"></span> Yes</a>	
									 <a href="index.php?a=message&m=thk" class="btn btn-danger '.(isset($theme_color)?$theme_color:'').'"><span class="fa fa-close"></span> No</a>';
						break;
					...
					case 'bill':
						...
						if($order == ''){
							...
							echo '<h3><i class="fa fa-info-circle"></i> Thank you for choosing to dine with us.</h3>
									 ...
									 <a href="index.php?a=feedback" class="btn btn-success '.(isset($theme_color)?$theme_color:'').'"><span class="fa fa-check"></span> Yes</a>	
									 <a href="index.php?a=message&m=thk" class="btn btn-danger '.(isset($theme_color)?$theme_color:'').'"><span class="fa fa-close"></span> No</a>';
						}
						break;
