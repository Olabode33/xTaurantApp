		...
		<form action="#" class="form-horizontal" id="newcus_form">
			<div class="col-md-10">
				...
				<div class="form-group">	
					...
					<div class="col-sm-4">
						<input type="text" id="nok" name="nok" class="form-control" placeholder="Next of Kin...">
					</div>
				</div>
	...
	<script>
		$(document).ready( function() {		
				...
				$.get('api/Customers_RestController.php?view=single&id='+id, function(data) {
					...
					if(data.status === undefined){
						$.each(data, function(i, item) {			
							...
							$("#rship_acc").val(item.rship_account);
							$("#dob").val(item.dob);
							$("#age").val(item.age);
			...
			$("#newcus_form").submit(function(e) { 
				...
				$.ajax({
					url: (id != undefined) ?  'api/Customers_RestController.php?view=edit&id=' + id : 'api/Customers_RestController.php?view=new',
					type: 'post',
					data : {
						'title' : $("#title").val(),
						'lname' : $("#sname").val(),
